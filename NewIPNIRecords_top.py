...
if results:
        ...
        with open('newIPNIrecords/Jan25/Caryophyllales_Jan.csv', 'w', newline='', encoding='utf-8') as csv_file:
        ...
        with open('newIPNIrecords/Jan25/Result_log.txt', 'a') as log_file:
        ...
        # Log the information to a file
        with open('newIPNIrecords/Jan25/noResult_log.txt', 'a') as log_file:
...
cursor.execute('''SELECT IPNIJan.rhakhis_wfo AS WFOID,
  ...
  FROM IPNIJan
       INNER JOIN
       PPGFamilies
 WHERE PPGFamilies.Family = IPNIJan.family_s_lower;
  ''')
...
if results:
        ...
        # Write the results to a CSV file
        with open('newIPNIrecords/Jan25/PPGFamilies_Jan.csv', 'w', newline='', encoding='utf-8') as csv_file:
            csv_writer = csv.writer(csv_file)
            # Write the column headers
            csv_writer.writerow(column_names)
            # Write the data rows
...
cursor.execute('''SELECT IPNIJan.rhakhis_wfo AS WFOID,
  ...
  FROM IPNIJan
       INNER JOIN
       Conifers
 WHERE Conifers.Family = IPNIJan.family_s_lower;
  ''')
...
if results:
        ...
        # Write the results to a CSV file
        with open('newIPNIrecords/Jan25/Conifers_Jan.csv', 'w', newline='', encoding='utf-8') as csv_file:
            csv_writer = csv.writer(csv_file)
            # Write the column headers
            csv_writer.writerow(column_names)
            # Write the data rows
...
cursor.execute('''SELECT IPNIJan.rhakhis_wfo AS WFOID,
  ...
  FROM IPNIJan
       INNER JOIN
       Cycads
 WHERE Cycads.Family = IPNIJan.family_s_lower;
  ''')
...
if results:
        ...
        # Write the results to a CSV file
        with open('newIPNIrecords/Jan25/Cycads_Jan.csv', 'w', newline='', encoding='utf-8') as csv_file:
            csv_writer = csv.writer(csv_file)
            # Write the column headers
            csv_writer.writerow(column_names)
            # Write the data rows
...
cursor.execute('''SELECT IPNIJan.rhakhis_wfo AS WFOID,
  ...
  FROM IPNIJan
       INNER JOIN
       Haloragaceae
 WHERE Haloragaceae.Family = IPNIJan.family_s_lower;
  ''')
...
if results:
        ...
        # Write the results to a CSV file
        with open('newIPNIrecords/Jan25/Haloragaceae_Jan.csv', 'w', newline='', encoding='utf-8') as csv_file:
            csv_writer = csv.writer(csv_file)
            # Write the column headers
            csv_writer.writerow(column_names)
            # Write the data rows
...
cursor.execute('''SELECT IPNIJan.rhakhis_wfo AS WFOID,
  ...
  FROM IPNIJan
       INNER JOIN
       Legumes
 WHERE Legumes.Family = IPNIJan.family_s_lower;
  ''')
...
if results:
        ...
        # Write the results to a CSV file
        with open('newIPNIrecords/Jan25/Legumes_Jan.csv', 'w', newline='', encoding='utf-8') as csv_file:
            csv_writer = csv.writer(csv_file)
            # Write the column headers
            csv_writer.writerow(column_names)
            # Write the data rows
...
for family_entry in query_list:
    ...
    cursor.execute('''SELECT IPNIJan.rhakhis_wfo AS WFOID,
        ...
        IPNIJan.basionym_s_lower AS originalName,
        IPNIJan.basionym_author_s_lower AS originalNameAuthor
    FROM IPNIJan WHERE IPNIJan.family_s_lower = ?''', (family_entry,))
    ...
    if results:
        ...
        file_name = f'newIPNIrecords/Jan25/{family_entry}_Jan.csv'
        print(file_name)
